...
| **Delete-Verhalten Store Products** | BC-App 1.0.20.0: Löschen einer *aktiven* Store-Product-Zeile ruft automatisch `remove=true` in nopCommerce auf (Produkt wird unpublished); bei API-Fehler wird das Löschen abgebrochen. Draft/Archived-Zeilen löschen ohne nop-Aufruf |
